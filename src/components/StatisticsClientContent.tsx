...
const ArticlesBarChart: React.ComponentType<ArticlesBarChartProps> = dynamic(() => import("@/components/charts/ArticlesBarChart").then((mod) => mod.ArticlesBarChart), {
  ssr: false,
  loading: () => (
...
const AcceptancePieChart: React.ComponentType<AcceptancePieChartProps> = dynamic(() => import("@/components/charts/AcceptancePieChart").then((mod) => mod.AcceptancePieChart), {
  ssr: false,
  loading: () => (
    <div className="flex items-center justify-center h-full">
      <Loader2 className="h-6 w-6 animate-spin text-primary" />
...
const CitationsLineChart: React.ComponentType<CitationsLineChartProps> = dynamic(() => import("@/components/charts/CitationsLineChart").then((mod) => mod.CitationsLineChart), {
  ssr: false,
  loading: () => (
    <div className="flex items-center justify-center h-full">
      <Loader2 className="h-6 w-6 animate-spin text-primary" />
