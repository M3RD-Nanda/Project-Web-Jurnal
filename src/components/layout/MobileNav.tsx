...
// import { ModeToggle } from "@/components/ui/mode-toggle"; // Removed ModeToggle
    ...
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      ...
      <SheetContent side="left" className="w-64 p-0 bg-sidebar text-sidebar-foreground border-r border-sidebar-border flex flex-col">
        <div className="flex items-center gap-x-2 p-4 border-b border-sidebar-border">
          <SheetTitle className="text-lg font-semibold text-sidebar-primary">Menu JIMEKA</SheetTitle>
