...
export async function GET(request: NextRequest) {
  try {
    ...
    const title = searchParams.get('title') || 'Jurnal Ilmiah Mahasiswa Ekonomi Akuntansi';
    const subtitle = searchParams.get('subtitle') || 'JIMEKA - Universitas Percobaan Nanda';
