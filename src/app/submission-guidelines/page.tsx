...
export default function SubmissionGuidelinesPage() {
  return (
    <StaticContentPage title="SUBMISSION GUIDELINES">
      <p>
        Jurnal Ekonomi Bisnis dan Akuntansi Mahasiswa (JEBAKA) mengundang para
        penulis untuk mengirimkan naskah orisinal mereka. Untuk memastikan
        kelancaran proses pengiriman dan peninjauan, mohon ikuti pedoman
        pengiriman berikut:
      </p>
      <h3 className="text-2xl font-semibold mt-8">Persyaratan Umum:</h3>
      <ul className="list-disc list-inside space-y-2">
        <li>
          Naskah harus orisinal dan belum pernah diterbitkan sebelumnya di
          jurnal lain.
        </li>
        <li>Naskah harus sesuai dengan fokus dan ruang lingkup JEBAKA.</li>
        <li>
          Penulis harus mematuhi etika publikasi yang ditetapkan oleh JEBAKA.
        </li>
      </ul>
      ...
      <ul className="list-disc list-inside space-y-2">
        ...
        <li>
          Gunakan gaya sitasi APA (American Psychological Association) edisi
          terbaru.
        </li>
      </ul>
      <h3 className="text-2xl font-semibold mt-8">Proses Pengiriman:</h3>
      <p>
        Naskah harus dikirimkan melalui sistem Open Journal Systems (OJS) kami.
        Pastikan semua informasi penulis lengkap dan akurat.
      </p>
      <p>
