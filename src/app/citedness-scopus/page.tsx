...
export default function CitednessScopusPage() {
  return (
    <StaticContentPage title="CITEDNESS IN SCOPUS">
      <p>
        Jurnal Ilmiah Mahasiswa Ekonomi Akuntansi (JIMEKA) sedang dalam proses pengajuan untuk diindeks di Scopus. Kami berkomitmen untuk memenuhi standar kualitas tinggi yang diperlukan untuk pengindeksan di basis data internasional terkemuka ini.
      </p>
      <p>
